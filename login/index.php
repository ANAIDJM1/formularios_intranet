...
while ($row = $user_retrieve->fetch()) {
	...
	$_SESSION['lastname'] = $row['lname'];
		...
		if($usertype_id == 3){
			echo "<script type='text/javascript'>window.location.href = '../system/system/personalcampo/home/index/';</script>";
			exit();
		}
		elseif ($usertype_id == 1) {
			echo "<script type='text/javascript'>window.location.href = '../system/system/proovedores/home/index/';</script>";
			exit();
		}
		elseif ($usertype_id == 2 || $usertype_id == 2 ) {
		...
		?> <script>
			alert('Intenta de nuevo, no es el usuario o la contraseña');
		</script>"; <?php
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="" method="POST">
					...
					<div class="container-login100-form-btn">
						<input type="submit" name="btn-login" value = "Iniciar" class="login100-form-btn">
					</div>
				</form>
			</div>
		</div>
