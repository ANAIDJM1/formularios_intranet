...
include("../../../connections/db-connect.php"); 
	...
	$stmt = "INSERT INTO tests ( user_id, total_questions, passing_rate, time_limit,  test_desc, test_subject, difficulty_id) 
	              VALUES ('$user_id','$total_questions','$passing_rate','$time_limit', '$test_desc', '$test_subject', '$difficulty_id')";
